...
- Create an ArcGIS Pro project (.aprx). 
  ...
  - The map name (title) has to be the service name. Letter cases, underscores, etc matter. Do not use space. Do not include version numbers.     -- e.g., The map title for "Passive Acoustic Monitoring" should be "Passive_Acoustic_Monitoring". 
